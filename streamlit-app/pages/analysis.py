...
df = pd.read_csv('/workspaces/MissedMatch/data/raw/KaggleV2-May-2016.csv')
...
st.image('/workspaces/MissedMatch/streamlit-app/resources/img/eli5.png')

st.subheader('Feature importanc with sklearn')
st.image('/workspaces/MissedMatch/streamlit-app/resources/img/sklearn.png')

st.subheader('Feature importanc with Mean decrease in impurity')
st.image('/workspaces/MissedMatch/streamlit-app/resources/img/MDI.png')